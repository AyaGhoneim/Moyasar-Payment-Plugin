...
//
//import com.braintreegateway.MoyasarGateway;
...
//@Singleton
//@Path("/clientToken")
//public class MoyasarTokenServlet {
//
//    private final MoyasarConfigPropertiesConfigurationHandler braintreeConfigPropertiesConfigurationHandler;
//
//    @Inject
//    public MoyasarTokenServlet(final MoyasarConfigPropertiesConfigurationHandler braintreeConfigPropertiesConfigurationHandler) {
...
//        final MoyasarConfigProperties config = braintreeConfigPropertiesConfigurationHandler.getConfigurable(tenant.map(Entity::getId).orElse(null));
//        final MoyasarGateway braintreeGateway = new MoyasarGateway(
