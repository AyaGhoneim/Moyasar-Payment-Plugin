...
public class MoyasarClientImpl implements MoyasarClient {
    ...
    String publicKey ="pk_test_jpCLAqhpDJvuvMxwSHAsuEvkFBnkFuyjvbV6dtQE"; // Replace with your actual public API key
    String apiKey = "sk_test_yGP6niNziaTVcLBGwyRve3f5kk6t58C7LpJd3jTr"; // Replace with your secret API key
